...
<div class="remodal" data-remodal-id="modal-resposta-recurso">
    ...
    <form>
        ...
        <div id="divDeferido" style="display: block">
            ...
            ?>
            <textarea placeholder="Motivo: " name="indeferido_reply" id="indeferido_reply" cols="30" rows="20" class="form-control" style="height: 120px !important; display: none;"></textarea>
