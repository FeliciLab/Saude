<?php
    ...
    //ENCONTRANDO/GUARDANDO OPORTUNIDADES TIPO 1
    $totalEdit = $app->repo('Opportunity')->findBy([
        '_type'=> 1, 
        'status'=> 1
    ]);

    //ENCONTRANDO/GUARDANDO OPORTUNIDADES TIPO 1
    $totalCon = $app->repo('Opportunity')->findBy([
        '_type'=> 6, 
        'status'=> 1
    ]);
     //SOMANDO A QUATIDADE DE EDITAIS E CONCURSOS
    $totalSum = count($totalEdit) + count($totalCon);
    ...
    <div id="search-results-header" class="clearfix">
        ...
        <div id="search-results">
            ...
            <span ng-if="!spinnerCount">
                ...
                <?php if (isset($_GET['type']) && $_GET['type'] == 'opp'): ?>
                ...
                <?php endif; 
                if (isset($_GET['type']) && $_GET['type'] == 'edital'): ?>
