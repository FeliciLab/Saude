<?php
// dump($entity->servicos_especializados);
// die();
?>
...
<div class="servico">
    ...
    <?php if($this->isEditable() || $entity->instituicao_servicos_especializados): ?>
    <p>
        <span class="label"><?php \MapasCulturais\i::_e("Serviços Especializados");?>: </span>
        <editable-multiselect entity-property="instituicao_servicos_especializados" empty-label="<?php \MapasCulturais\i::esc_attr_e('Selecione');?>" allow-other="true" box-title="<?php \MapasCulturais\i::esc_attr_e('Selecione:');?>"></editable-multiselect>
    </p>

    <?php if($this->isEditable() || $entity->instituicao_tipos_unidades): ?>
    <p><span class="label"><?php \MapasCulturais\i::_e("Tipos de unidade");?>: </span><span class="js-editable" data-edit="instituicao_tipos_unidades" data-original-title="<?php \MapasCulturais\i::esc_attr_e('Selecione');?>"><?php echo $entity->instituicao_tipos_unidades; ?></span></p>
    <?php endif; ?>

    <?php if($this->isEditable() || $entity->instituicao_tipos_gestao): ?>
    <p><span class="label"><?php \MapasCulturais\i::_e("Tipos de gestão");?>: </span><span class="js-editable" data-edit="instituicao_tipos_gestao" data-original-title="<?php \MapasCulturais\i::esc_attr_e('Selecione');?>"><?php echo $entity->instituicao_tipos_gestao; ?></span></p>
    <?php endif; ?>
