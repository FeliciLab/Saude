...
?>
<p ng-if="!data.isEditable && data.entity.registrationRulesFile"><a class="btn btn-default download" href="{{data.entity.registrationRulesFile.url}}" target="_blank" rel='noopener noreferrer'><?php echo !empty($labelCustomRules) ? $labelCustomRules : $labelCustomRulesDefault; ?> </a></p>
