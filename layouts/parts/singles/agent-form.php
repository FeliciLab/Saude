...
<div class="ficha-spcultura">
    ...
    <!--. hook tab-about-service:before -->

    <div class="servico">
        <?php $this->applyTemplateHook('tab-about-service', 'begin'); ?>
        <!--. hook tab-about-service:begin -->
    ...
    <?php if ($this->isEditable()) : ?>
        ...
        <div class="registration-form-content-input">
            <div ng-click="editbox.open('editbox-select-registration-owner_<?php echo $entity->id; ?>', $event)">
                <span class="icon icon-private-info"></span>
                <span class="label"><?php \MapasCulturais\i::_e("Gênero"); ?> <i class="fa fa-question-circle-o"></i>:</span>
            </div>
    ...
    <!--. hook tab-about-service:end -->
    </div>
    <!--.servico -->

    <?php $this->applyTemplateHook('tab-about-service', 'after'); ?>
    <!--. hook tab-about-service:after -->
