...
echo $dtN ? $dtN->format('d/m/Y') : '';?>
            ...
            <p class="privado">
                <span class="icon icon-private-info"></span>
                <span class="label"><?php \MapasCulturais\i::_e("Gênero");?> <i class="fa fa-question-circle-o" data-remodal-target="modal-info-registration-confirm"></i>:</span>
