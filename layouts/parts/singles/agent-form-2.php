        ...
        <?php if($entity->canUser("viewPrivateData")): ?>
            <?php if($this->isEditable() || $canSee('personalData')):?>
                ...
                <p class="privado" document-wrapper>
                    ...
                    <span class="js-editable <?php echo ($entity->isPropertyRequired($entity,"documento") && $editEntity? 'required': '');?>" data-edit="documento" data-original-title="<?php \MapasCulturais\i::esc_attr_e("CNPJ");?>" data-emptytext="<?php \MapasCulturais\i::esc_attr_e("Informe seu CNPJ com pontos, hífens e barras");?>">
