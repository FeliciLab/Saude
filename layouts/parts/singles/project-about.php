...
<div id="sobre" class="aba-content">
    ...
    <div class="ficha-spcultura">
        ...
        <div class="servico">
            ...
            <?php if($this->isEditable() || $entity->project_taxonomia): ?>
                <p><span class="label"><?php \MapasCulturais\i::_e("Taxonomia");?>: </span><span class="js-editable" data-edit="project_taxonomia" data-original-title="<?php \MapasCulturais\i::esc_attr_e('Taxonomia');?>"><?php echo $entity->project_taxonomia; ?></span></p>
            <?php endif; ?>
