    ...
    if(url_atual.includes(url_base +'inscricao/')){
        $("a").click(function(event) {
            ...
            if(href.includes(url_base)){
                ...
                $('body').append('<div class="remodal modal-border" data-remodal-id="modal-information-message"><button data-remodal-action="close" class="remodal-close"></button><h3>Você está saindo da seção de inscrição</h3><div><h4 style="color: #F26822; font-weight: bold;">Você tem certeza disso?</h4></div><div><p>Ao sair desta página, <b>você não perde sua inscrição,</b><br>ela ficará salva para depois:</p><p>Você poderá continuar esta inscrição em: <br><b>Meu Perfil -> Minhas Inscrições -> Rascunho </b></p></div><br><div style="float: right;"><button data-remodal-action="cancel" class="btn btn-default" title="Sair da resposta" style="margin-right: 15px;"> Voltar</button><a class="btn btn-primary" id="dataComfirmOK" href="'+href+'" >Confirmar</a></form></div></div>');
